...
# file_to_load = os.path.join("/Users/Angelina/Desktop/DA_Course/classwork_Spot/challenges/03.04-Challenge-Starter_Code/03_python-challenge/PyPoll/Resources", "election_data.csv")  # Input file path
